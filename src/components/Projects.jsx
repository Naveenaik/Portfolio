  ...
  return (
    <div id="projects" className="bg-black text-gray-400  max-w-[1200px] mx-auto px-5 md:px-4 md:my-0  my-16 ">
      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-3 ">
        ...
        <ProjectCard image={p6} btnText={"View"} link={"https://ecommerce-software-testing.vercel.app/"} title={"Ecommerce Website"} description={"A website is created to do the software testing using selenium automation tool"} />
      </div>
