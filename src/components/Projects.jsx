  ...
  return (
    <div id="projects" className="bg-black text-gray-400  max-w-[1200px] mx-auto px-5 md:px-4 md:my-0  my-16 ">
      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-3 ">
        ...
        <ProjectCard image={p1} btnText={"View"} gitlink={"https://github.com/Naveenaik/Library-System-Management"} title={"Library System Management"} cursor={"cursor-not-allowed"} description={"A responsive library system app with React, Express/Node.js, and MySQL, featuring book cataloging, user management, and inventory control."} />
        ...
        <ProjectCard image={p7} btnText={"View"} gitlink={"https://github.com/Naveenaik/DealsDray"} link={"https://deals-dray-frontend-xi.vercel.app/"} title={"Employee Registration"} description={"A task assigned by the DealsDray as part of the machine test of the code"} />
      </div>
